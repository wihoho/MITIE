...
SWIGEXPORT void JNICALL Java_edu_mit_ll_mitie_globalJNI_MicroTrainer_1setC(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jdouble jarg2) {
  MicroTrainer *arg1 = (MicroTrainer *) 0 ;
  double arg2 ;
...
SWIGEXPORT void JNICALL Java_edu_mit_ll_mitie_globalJNI_MicroTrainer_1setLoss(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jdouble jarg2) {
  MicroTrainer *arg1 = (MicroTrainer *) 0 ;
  double arg2 ;
...
SWIGEXPORT void JNICALL Java_edu_mit_ll_mitie_globalJNI_MicroTrainer_1setEnableSegmenter(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jboolean jarg2) {
  MicroTrainer *arg1 = (MicroTrainer *) 0 ;
  bool arg2 ;
...
SWIGEXPORT void JNICALL Java_edu_mit_ll_mitie_globalJNI_MicroTrainer_1setEnableTuningClassifier(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jboolean jarg2) {
  MicroTrainer *arg1 = (MicroTrainer *) 0 ;
  bool arg2 ;
  ...
  {
    try {
      (arg1)->setEnableTuningClassifier(arg2);
    } catch(std::exception& e) {
      jclass clazz = jenv->FindClass("java/lang/Exception");
      jenv->ThrowNew(clazz, e.what());
      return ;
...
SWIGEXPORT void JNICALL Java_edu_mit_ll_mitie_globalJNI_MicroTrainer_1trainSeparateModels(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_, jstring jarg3) {
  ...
  {
    try {
      (arg1)->trainSeparateModels((TotalWordFeatureExtractor const &)*arg2,(std::string const &)*arg3);
    } catch(std::exception& e) {
      jclass clazz = jenv->FindClass("java/lang/Exception");
      jenv->ThrowNew(clazz, e.what());
      return ;
...
SWIGEXPORT jdouble JNICALL Java_edu_mit_ll_mitie_globalJNI_MicroTrainer_1getPrecision(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jdouble jresult = 0 ;
  MicroTrainer *arg1 = (MicroTrainer *) 0 ;
  double result;
  ...
  {
    try {
      result = (double)(arg1)->getPrecision();
    } catch(std::exception& e) {
      jclass clazz = jenv->FindClass("java/lang/Exception");
      jenv->ThrowNew(clazz, e.what());
      return 0;
...
SWIGEXPORT jdouble JNICALL Java_edu_mit_ll_mitie_globalJNI_MicroTrainer_1getRecall(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jdouble jresult = 0 ;
  MicroTrainer *arg1 = (MicroTrainer *) 0 ;
  double result;
